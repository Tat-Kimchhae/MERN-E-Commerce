...
const Cart = () => {
    ...
    const {products, currency, cartItems, updateQuantity, deleteCartItems, navigate} = useContext(ShopContext);
                    ...
                    cartData.map((item, index) => {
                        ...
                        return (
                            <div key={index} className="py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4">
                                ...
                                <img onClick={() => deleteCartItems(item._id, item.size)} className='w-4 mr-4 sm:w-5 cursor-pointer' src={assets.bin_icon}/>
                            </div>
                        )
                    })
                }
